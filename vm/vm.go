...
func (vm *VM) push(o object.Object) error {
	if vm.sp >= StackSize {
		return fmt.Errorf("stack overlow")
	}
...
func (vm *VM) excuteBinaryIntegerOperation(
	op code.Opcode,
	...
	case code.OpDiv:
		result = leftValue / rightValue
	default:
		return fmt.Errorf("unknown integer operand. %d", op)
	}
...
func (vm *VM) executeIntegerComparison(
	...
	default:
		return fmt.Errorf("unkonown operator: %d", op)
	}
}
