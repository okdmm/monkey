...
func TestStringConcatenation(t *testing.T) {
	...
	if str.Value != "Hello World!" {
		t.Errorf("Stinr gas wrong value. got=%q", str.Value)
	}
}
...
func TestArrayLiterals(t *testing.T) {
	...
	if len(result.Elements) != 3 {
		t.Fatalf("array has wrong num of elemnts %d", len(result.Elements))
	}
...
func TestArrayIndexExpressions(t *testing.T) {
	tests := []struct {
		...
		{
			"let myArray = [1, 2, 3]; myArray[1] + myArray[0] + myArray[2];",
			6,
		},
		{
